...
<section class="u-clearfix u-section-1" id="sec-a151">
  <div class="u-clearfix u-sheet u-sheet-1" style="min-height: auto;">
	<div id="comments" class="comments-area">
		<?php if ( have_comments() ) : ?>
			<h3 class="comments-title">
				...
				if ( 1 === $comments_number ) {
					...
					printf( _x( 'One thought on &ldquo;%s&rdquo;', 'comments title', 'site3' ), get_the_title() );
				} else {
					printf(
		...
		if ( ! comments_open() && get_comments_number() && post_type_supports( get_post_type(), 'comments' ) ) :
			?>
			<p class="no-comments "><?php _e( 'Comments are closed.', 'site3' ); ?></p>
		<?php endif; ?>
